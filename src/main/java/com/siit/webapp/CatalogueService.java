...
public class CatalogueService {
    ...
    public Map<Student, Double> calculateAverageSortGrades (HashMap<Student, List<Integer>> studentWithGrades) {
    ...
    public String createStudentRank(){
        Map<Student, Double> studentListToBeDisplayed = calculateAverageSortGrades(studentsRepository.addGradesToStudents(studentsRepository.getStudents()));
